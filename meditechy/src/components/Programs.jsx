...
const Programs = () => {
    ...
    return (
        ...
        // </>
        <>
        <div className='flex flex-col h-[600px] md:flex md:flex-row md:h-[400px] 
        lg:h-[500px] mx-[10px] md:mx-[20px] lg:mx-[40px] 
        lg:mt-[120px] mt-[30px] md:mt-[40px]'>
            <div data-aos-delay="400" data-aos-duration="400" data-aos-offset="250" 
            data-aos='zoom-in' 
            className="w-full md:w-[50%] rounded-tl-[50px]  rounded-br-[50px] shadow-lg">
                {loading ? (
                    <Skeleton height="100%" width="100%" />
                ) : (
                    <img className='h-[100%] w-[100%] object-cover object-center rounded-tl-[50px] 
                    rounded-br-[50px]' src={Program1} alt="" />
                )}
            </div>
            <div data-aos-delay="400" data-aos-duration="400" data-aos-offset="250" 
            data-aos='zoom-in' className='w-full md:w-[50%]'>
                <div className='h-[100%] flex flex-col'>
                    <h1 className='text-2xl md:text-2xl lg:text-4xl font-bold text-center 
                    pt-[50px] my-[10px]'>
                    ...
                    {loading ? (
                        ...
                        <button className='border-[2px] border-black hover:border-sky-500 
                        hover:bg-white hover:text-sky-500 bg-sky-500 text-white rounded-[7px] 
                        shadow-sm py-[15px] px-[20px] text-xl w-[40%] md:w-[50%] lg:w-[30%]
                        ml-[120px] 
                        md:ml-[50px]'>
                            Register here
                        </button>
        ...
        <div className='flex flex-col h-[600px] md:flex md:flex-row md:h-[400px] 
        lg:h-[500px] mx-[10px] md:mx-[20px] lg:mx-[40px] 
        lg:mt-[120px] mt-[60px] md:mt-[40px]'>
            <div data-aos-delay="400" data-aos-duration="400" data-aos-offset="250" 
            data-aos='zoom-in' 
            className="w-full md:w-[50%] rounded-tl-[50px]  rounded-br-[50px] shadow-lg">
                {loading ? (
                    ...
                    <img className='h-[100%] w-[100%] object-cover object-center rounded-tl-[50px] 
                    rounded-br-[50px]' src={Startup} alt="" />
                )}
            </div>
            <div data-aos-delay="400" data-aos-duration="400" data-aos-offset="250" 
            data-aos='zoom-in' className='w-full md:w-[50%]'>
